...
public class SwimInRisingWater {
    public int swimInWater(int[][] grid) {
        ...
        PriorityQueue<Integer> pq = new PriorityQueue<>((pos1, pos2) -> grid[pos1/N][pos1 % N] - grid[pos2/N][pos2%N]);
        ...
        while(!pq.isEmpty()) {
            ...
            for (int[] direction : directions) {
                ...
                int newPosition = newRow * N + newColumn;

                if (newRow < 0 ||  newColumn < 0 || newRow >= N  || newColumn >= N || seen.contains(newPosition)) {
                    continue;
                }
